  ...
  return (
    <div className='flex flex-row'>
      <div className='w-1/2'>
        ...
        <select value={`${major}/${minor}`} id='version' onChange={onVersionChange} className='block w-full leading-4 rounded border-gray-300 rounded-md focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-black dark:text-gray-200 dark:bg-dark-gray-900 dark:border-dark-gray-800'>
          {options}
        </select>
      </div>
      <div className='w-1/2 ml-4'>
        ...
        {files && (
          <select value={file} id='file' onChange={onFileChange} className='block w-full leading-4 rounded border-gray-300 rounded-md focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-black dark:text-gray-200 dark:bg-dark-gray-900 dark:border-dark-gray-800'>
