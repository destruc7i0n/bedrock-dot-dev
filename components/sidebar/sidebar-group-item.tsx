    ...
    <li className='my-2'>
      <a
        className={cn(
          ...
          { 'text-blue-600 hover:text-blue-500 dark:text-blue-500 dark-hover:text-blue-400 font-semibold': active, 'hover:text-black text-gray-800 dark:text-gray-300 dark-hover:text-gray-200': !active },
