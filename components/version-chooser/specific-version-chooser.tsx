  ...
  return (
    <>
      <div className='w-1/2 mb-2 pr-2'>
        ...
        <select id='major' className='border-gray-300 rounded-md focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 dark:text-gray-200 dark:bg-dark-gray-900 dark:border-dark-gray-800 leading-5 w-full' value={major} onChange={({ target: { value } }) => setMajor(value)}>
      ...
      <div className='w-1/2 mb-2'>
        ...
        <select id='minor' className='border-gray-300 rounded-md focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 dark:text-gray-200 dark:bg-dark-gray-900 dark:border-dark-gray-800 leading-5 w-full' value={minor} onChange={({ target: { value } }) => setMinor(value)}>
