...
const LanguageSelect: FunctionComponent<Props> = ({ className }) => {
  ...
  return (
    <div className={cn('relative dark:text-gray-200', className)}>
      ...
      <select value={localeValue} onChange={({ target: { value } }) => setLocaleValue(value as Locale)} id='locale' className='leading-4 border-gray-300 rounded-md focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 dark:bg-dark-gray-900 dark:border-dark-gray-800 text-sm py-2 pl-2 block'>
