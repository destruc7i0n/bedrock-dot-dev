    ...
    <div className={cn('w-full py-12 px-4 overflow-hidden sm:px-6 lg:px-8', { [darkClass]: dark }, { 'border-t border-gray-200 dark:border-dark-gray-800': outline })}>
      <div className='max-w-screen-lg mx-auto space-y-3'>
        <div className='flex flex-wrap justify-center font-medium'>
          ...
          <div className='px-2'>
            <a href='https://patreon.com/destruc7i0n' className='link' target='_blank' rel='noopener'>{t('component.footer.donate')}</a>
          </div>
        </div>
        <div className='flex flex-wrap justify-center font-medium'>
          <div className='px-2'>
            <a className='link' href='https://github.com/destruc7i0n/bedrock-dot-dev' target='_blank' rel='noopener'>{t('component.footer.github')}</a>
          </div>
        </div>
        ...
        {showToggles && (
          <div className='!mt-9 grid grid-cols-2 gap-2'>
            <div className='justify-self-end'><LanguageSelect /></div>
            <div className='justify-self-start'><ModeSelect /></div>
          </div>
        )}
      </div>
    </div>
