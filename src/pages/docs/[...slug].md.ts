...
// only the tagged routes get a markdown twin, same as the sitemap
...
export const GET: APIRoute = async ({ props }) => {
  ...
  // same transforms as the page, minus the display-only highlighting and anchors
  ...
  // so an agent landing on a single page can still find the rest
  const banner = [
